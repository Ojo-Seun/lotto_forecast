 ...
 * follow by two nums at any pos in secondToLastEvent
 * follow by two nums at any pos in thirdToLastEvent
 */
@Injectable()
export class TwoTwoTwoAny {
  ...
  constructor(private readonly matchFn: MatchFnService, private readonly threeWeeksSearchService: ThreeWeeksSearchService) {
    this.threeWeeksmatchFns = {
      ...
      isMatchSecondEvent: this.matchFn.twoNumsAnyPos,
