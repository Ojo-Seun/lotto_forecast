...
/**
 * one num at the same pos in last event in winning
 * follow by two nums at  pos in last event in machine
 */
@Injectable()
export class OneWinTwoMac {
  ...
  constructor(private readonly matchFn: MatchFnService, private readonly oneWeekSearchService: OneWeekSearchService) {
    this.oneWeekmatchFns = {
      isMatchInWin: this.matchFn.oneNumsAtPos,
      isMatchInMac: this.matchFn.twoAtPos,
    }
  }
