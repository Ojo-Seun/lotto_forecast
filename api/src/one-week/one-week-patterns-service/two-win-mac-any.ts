...
/**
 * two nums close in last event in winning
 * follow by two nums closein last event in machine
 */
@Injectable()
export class TwoWinMacAny {
  ...
  constructor(private readonly matchFn: MatchFnService, private readonly oneWeekSearchService: OneWeekSearchService) {
    this.oneWeekmatchFns = {
      isMatchInWin: this.matchFn.twoCloseNumsAnyPos,
      isMatchInMac: this.matchFn.twoCloseNumsAnyPos,
    }
  }
